...
const { charRange, isHexString, xor } = require("../../utils");

const candidateKeys = [...charRange("A", "Z"), ...charRange("a", "z")];
...
function isValidChar(char) {
    ...
    return charCode > 31 && charCode < 127; // ASCII codes from space to tilde.
}
...
rl.question("What's the hex encoded string?\n", (ciphertext) => {
    ...
    const [key, plaintext] = findPlaintext(ciphertext);
